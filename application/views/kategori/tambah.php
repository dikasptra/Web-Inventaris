<div class="container">
    ...
    <div class="row mt-2">
        ...
        <form method="post" id="form_advanced_validation">
            ...
            <input type="text" class="form-control" id="kode" name="kode_kat" autocomplete="off" required>
            <small class="form-text text-danger"><?= form_error('kode_kat'); ?></small>
            </div>
            <div class="mb-3">
                <label for="nama" class="form-label">Nama Kategori</label>
            <input type="text" class="form-control" id="nama" name="nama_kat" autocomplete="off" required>

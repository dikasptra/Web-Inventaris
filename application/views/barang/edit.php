<div class="container">
    <div class="row mt-2">
        <div class="col-md-12">
            <h1>Formulir edit data barang</h1>
            <hr>
        </div>
    </div>
        ...
        <div class="col-md-12">
            <form action="" method="post" id="form_advanced_validation">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="kode_brg" name="kode_brg" required value="<?= $barang['nama_brg']; ?>">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="nama_brg" name="nama_brg" required value="<?= $barang['nama_brg']; ?>">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="kondisi" name="kondisi" required value="<?= $barang['kondisi']; ?>">
                    <small class="form-text text-danger"><?= form_error('kondisi'); ?></small>
                </div>

                <button type="update" class="btn btn-success">Save</button>
            </form>
        </div>
    </div>
    <!-- end div container -->
